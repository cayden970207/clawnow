...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    channels: "管理频道和设置。",
    whatsapp: "查看已发现群组和社区的 JID。",
    tasks: "监控和追踪所有渠道的 agent 任务。",
  ...
  chat: {
    ...
    refreshTitle: "刷新聊天数据",
    openDesktopLive: "打开桌面直播",
    openDesktopLiveTitle: "在新标签页打开 VM 桌面",
    desktopLiveUnavailable: "当前环境不可用，无法打开桌面直播。",
    desktopLivePopupBlocked: "弹窗被浏览器拦截，请允许此站点弹窗后重试。",
