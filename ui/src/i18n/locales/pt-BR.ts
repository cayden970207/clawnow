...
export const pt_BR: TranslationMap = {
  common: {
    ...
    resources: "Recursos",
    live: "AO VIVO",
    liveHint: "O agente esta usando automacao de navegador agora.",
  },
  nav: {
    chat: "Chat",
    control: "Controle",
  ...
  subtitles: {
    ...
    whatsapp: "Ver os JIDs descobertos de grupos e comunidades.",
    tasks: "Monitore e acompanhe tarefas do agente em todos os canais.",
  ...
  chat: {
    ...
    openDesktopLive: "Abrir Desktop Live",
    openDesktopLiveTitle: "Abrir o desktop da VM em uma nova aba",
    desktopLiveUnavailable: "Desktop Live nao esta disponivel neste ambiente.",
    desktopLivePopupBlocked: "Popup bloqueado. Permita popups para este site e tente novamente.",
