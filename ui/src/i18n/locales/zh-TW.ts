...
export const zh_TW: TranslationMap = {
  ...
  subtitles: {
    ...
    channels: "管理頻道和設置。",
    whatsapp: "查看已發現群組與社群的 JID。",
    tasks: "監控和追蹤所有頻道的 agent 任務。",
  ...
  chat: {
    ...
    refreshTitle: "刷新聊天數據",
    openDesktopLive: "開啟桌面直播",
    openDesktopLiveTitle: "在新分頁開啟 VM 桌面",
    desktopLiveUnavailable: "目前環境不可用，無法開啟桌面直播。",
    desktopLivePopupBlocked: "彈窗被瀏覽器封鎖，請允許此網站彈窗後重試。",
