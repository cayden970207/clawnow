...
export const en: TranslationMap = {
  common: {
    ...
    resources: "Resources",
    live: "LIVE",
    liveHint: "Agent is actively using browser automation.",
  },
  nav: {
    chat: "Chat",
    control: "Control",
  ...
  subtitles: {
    ...
    whatsapp: "View discovered group and community JIDs.",
    tasks: "Monitor and track agent tasks across all channels.",
  ...
  chat: {
    ...
    openDesktopLive: "Open Desktop Live",
    openDesktopLiveTitle: "Open the VM desktop in a new tab",
    desktopLiveUnavailable: "Desktop Live is unavailable in this environment.",
    desktopLivePopupBlocked: "Popup blocked. Allow popups for this site and try again.",
